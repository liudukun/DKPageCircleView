...
NSString* const DKAnimationTypeMoveIn1;
...
/// 设置每一个page
- (UIView *)pageScrollView:(DKPageCircleView *)pageScroll viewOfPage:(NSUInteger)page;

@optional

/// page 被选择的时候被调用
- (void)pageScrollView:(DKPageCircleView *)pageScroll viewSelectedOfPage:(NSUInteger)page ;
